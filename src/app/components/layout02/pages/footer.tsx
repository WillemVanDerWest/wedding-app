    ...
    return(
        <div className="w-full min-h-[400px] flex flex-col mt-auto bg-[#332D2B] justify-center">
            <div className="flex justify-evenly">
                ...
                <div className=" w-1/3 flex flex-col items-center "><Image alt="nothing" src={''} width={20} height={20}/> <button className="border-solid border-gray-800 border-2 px-12 py-4 text-2xl rounded-full">Details</button></div>
